...
const ProductDetails = () => {
  ...
  return (
   <>
     <div className=" sm:flex-row-reverse flex flex-col gap-16 max-w-[90rem] pb-24 m-auto min-h-[calc(100dvh-96px)] md:h-[calc(100dvh-108px)] ">
     ...
     <Description review={review} setReview={setReview} />
   </>
  )
}
